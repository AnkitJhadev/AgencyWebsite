...
import { solutionSteps } from "./site-data";
...
export function SolutionSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-black px-6 py-28 text-white">
      ...
      <div ref={sectionRef} className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          <motion.p
        ...
        >
          ...
          <div className="relative grid gap-5 sm:grid-cols-2">
            {solutionSteps.map((step, index) => (
              ...
              >
                ...
                {/* Shimmer — paused when section is off-screen */}
                {isInView && (
                  <motion.div
                    animate={{ x: ["-40%", "120%"] }}
                    transition={{ duration: 4, repeat: Infinity, delay: index * 0.42, ease: "easeInOut" }}
                ...
                <div className="relative flex h-full flex-col justify-between">
                  <div>
                    ...
                    <h3 className="mt-5 bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-3xl font-semibold text-transparent" style={{ WebkitTextStroke: "1px rgba(255,255,255,0.12)" }}>
                      {step.title}
                    </h3>
                  </div>
          ...
          <div className="relative mt-6 rounded-[1.25rem] border border-green-400/20 bg-green-400/10 p-5">
            <div className="grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-center">
              <div className="text-sm font-semibold uppercase tracking-[0.24em] text-green-300">Outcome</div>
              <p className="leading-7 text-slate-200">
                A founder knows what to build, why it matters, how it launches, and what has to improve next.
              </p>
              <motion.div
